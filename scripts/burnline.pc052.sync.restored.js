...
/* =========================================================
   PC052 Late Neutralisation (Additive)
   Purpose:
     - Ensure PC052 visual rendering is disabled AFTER PC066 loads.
     - Prevent DOM overwrite of #burnline while preserving sync logic.
   ========================================================= */

document.addEventListener("DOMContentLoaded", () => {
  try {
    const has066 = !!window.__CE_BOOT?.modules?.BurnlineVisual;
    if (has066) {
      _pc052Disabled = true;
      console.log("[PC052] Late-neutralised: PC066 detected after load — visuals suppressed, sync preserved.");
    }
  } catch (e) {
    console.warn("[PC052] Late-neutralisation failed:", e);
  }
});
